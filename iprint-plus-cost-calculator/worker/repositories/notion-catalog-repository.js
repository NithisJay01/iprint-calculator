...
function notionCatalogItem(page, type) {
  ...
  return normalizeCatalogItem({
    ...
    material3dKey: properties['3D Material Key']?.select?.name || '',
    materialFamily: properties['Material Family']?.select?.name || '',
    specValue: properties['Spec Value']?.number ?? null,
    specUnit: properties['Spec Unit']?.select?.name || '',
